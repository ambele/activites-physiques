...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityTransitionsPendingIntent =
                PendingIntent.getBroadcast(MainActivity.this, 0, intent, flags);
    ...
    protected void onStart() {
        ...
        // On Android 14+, we must specify RECEIVER_EXPORTED or RECEIVER_NOT_EXPORTED.
        // Since the broadcast is sent by Play Services via a PendingIntent, we use RECEIVER_EXPORTED.
